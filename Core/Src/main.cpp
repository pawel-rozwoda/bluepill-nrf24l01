...
MeasurementsController g_MeasurementSide;
uint8_t g_nrfConfigData[50];

#ifdef RECEIVER
RecipientNode g_Node;
#endif
...
int main(void)
{
  ...
  g_Mhz19Handler.Init(&huart2);
  g_MeasurementSide.Init(&g_DhtHandler, &g_Mhz19Handler);
  g_LcdHandler.Hd44780Init(hi2c1, 4);
  g_Node.Init(&g_LcdHandler, &g_NrfHandler, &g_MeasurementSide);
